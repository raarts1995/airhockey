...
# ACDS 16.1 196 win32 2018.02.21.16:35:18
# ----------------------------------------
...
# ----------------------------------------
# If pll65mhz is one of several IP cores in your
...
alias com {
  echo "\[exec\] com"
  eval  vlog -v2k5 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/pll65mhz.vo"
}
