...
(
    ...
    localparam PAD1 = log2ceil(64'h42000 - 64'h41000); 
    localparam PAD2 = log2ceil(64'h43000 - 64'h42800); 
    localparam PAD3 = log2ceil(64'h43040 - 64'h43000); 
    localparam PAD4 = log2ceil(64'h43048 - 64'h43040); 
    // -------------------------------------------------------
    ...
    // ( 0x43040 .. 0x43048 )
    if ( {address[RG:PAD4],{PAD4{1'b0}}} == 19'h43040   ) begin
